/*
       ...
       under the License.
*/
package no.apility.cordova.beacon;
...
public class LocationManager extends CordovaPlugin implements BeaconConsumer {
    ...
    public static final String TAG = "no.apility.beacon";
    private static final int PERMISSION_REQUEST_COARSE_LOCATION = 1;
    private static final String FOREGROUND_SCAN_PERIOD_NAME = "BeaconForegroundScanPeriod";
    private static final String FOREGROUND_BETWEEN_SCAN_PERIOD_NAME = "BeaconForegroundBetweenScanPeriod";
